...
There commands will download, install and run a local MongoDB Docker Instance. We are giving You can check if the instance was created properly by executing the command:
