...
&emsp;`$ git clone git@gitlab.com:miguelamello/nest.js.git` <br>
...
&emsp;`$ sudo docker pull mongo` //--> Once only.<br>
...
The application will be accessible for testing and operation at `http://localhost:14000`.
...
&emsp; `sudo docker build -t stock-quote .`  //--> Once only.

Run the Application Docker Image:

&emsp; `sudo docker run -p 14000:14000 stock-quote`
