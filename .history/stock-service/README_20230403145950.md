...
Note: Use the file `env.ts` on the `src` directory on the project root to configure your application instance regarding MongoDB URI and also another local variables. YOU SHOULD START
